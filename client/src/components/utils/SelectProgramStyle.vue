    ...
    mounted() {
        ...
        if(Array.isArray(selectedItem)) {
            for(let item of selectedItem) {
                for(let availableItem of this.availableItems) {
                    if((<string>availableItem.title).toLowerCase() == item.toLowerCase() || (<string>availableItem.id) == item.toLowerCase()) {
        ...
        if(typeof selectedItem === 'string') {
            for(let item of this.availableItems) {
                if((<string>item.title).toLowerCase() == selectedItem.toLowerCase() || (<string>item.id) == selectedItem.toLowerCase()) {
